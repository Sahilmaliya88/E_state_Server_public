...
export const addProperty = checkAsync(async(req:Request,res:Response,next:NextFunction)=>{
    ...
    if(property){
        ...
        const prop_photos = photos.map((ele:{photo:string,photoId:string})=>{
...
export const getProperty = checkAsync(async(req:Request,res:Response,next:NextFunction)=>{
    let property:any = await redis.get(`prop-${req.params.id}`)
    if(!property){
...
const allowedQuery =(queryObj:any,...args:string[])=>{
    const resObj:any= {}
...
export const getProperties = checkAsync(async(req:Request,res:Response,next:NextFunction)=>{
    const query:any = allowedQuery(req.query,"page","limit")
    console.log(query)
...
//separate filtering
export const fileterProperty = checkAsync(async(req:Request,res:Response,next:NextFunction)=>{
...
export const delPropertis = checkAsync(async(req:uRequest,res:Response,next:NextFunction)=>{
...
const checkField_In_Card=(dataobj:any):boolean=>{
...
export const editproperty = checkAsync(async(req:Request,res:Response,next:NextFunction)=>{
    const data = req.body
    const id = req.params.id
