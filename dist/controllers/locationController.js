...
export const addLocation = checkAsync(async (req, res, next) => {
...
export const editlocation = checkAsync(async (req, res, next) => {
...
export const makeDefaultLocation = checkAsync(async (req, res, next) => {
...
export const deleteLocation = checkAsync(async (req, res, next) => {
    const id = req.params.id;
